...
public final class ViewPager2 extends ViewGroup {
    ...
    void setCurrentItemInternal(int item, boolean smoothScroll) {
        ...
        if (item2 == this.mCurrentItem && smoothScroll) {
            return;
        }
    ...
    public class PageAwareAccessibilityProvider extends AccessibilityProvider {
        ...
        void updatePageAccessibilityActions() {
            int itemCount;
            int actionIdPageForward;
            ViewPager2 viewPager = ViewPager2.this;
            int actionIdPageBackward = android.R.id.accessibilityActionPageLeft;
            ViewCompat.removeAccessibilityAction(viewPager, android.R.id.accessibilityActionPageLeft);
            ViewCompat.removeAccessibilityAction(viewPager, android.R.id.accessibilityActionPageRight);
            ViewCompat.removeAccessibilityAction(viewPager, android.R.id.accessibilityActionPageUp);
            ViewCompat.removeAccessibilityAction(viewPager, android.R.id.accessibilityActionPageDown);
            ...
            if (ViewPager2.this.getOrientation() == 0) {
                ...
                if (isLayoutRtl) {
                    actionIdPageForward = 16908360;
                } else {
                    actionIdPageForward = 16908361;
                }
                if (isLayoutRtl) {
            ...
            if (ViewPager2.this.mCurrentItem < itemCount - 1) {
                ViewCompat.replaceAccessibilityAction(viewPager, new AccessibilityNodeInfoCompat.AccessibilityActionCompat(android.R.id.accessibilityActionPageDown, null), null, this.mActionPageForward);
            }
            if (ViewPager2.this.mCurrentItem > 0) {
                ViewCompat.replaceAccessibilityAction(viewPager, new AccessibilityNodeInfoCompat.AccessibilityActionCompat(android.R.id.accessibilityActionPageUp, null), null, this.mActionPageBackward);
            }
        }
